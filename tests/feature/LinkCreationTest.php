...
class LinkCreationTest extends TestCase
{
     ...
     * @return void
     */
    public function fails_if_no_url_is_given()
    {
    ...
    public function fails_if_url_is_inavlid()
    {
        $response = $this->json('POST', '/',[
                            'url' => 'http://google^%&%$%**',   
                        ])
     ...
     */
      ...
      */
       ...
       * @test
       * */
      public function last_requested_date_is_updated_for_requested_link()
      {
